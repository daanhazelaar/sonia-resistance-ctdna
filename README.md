...
Download the data from Zenodo into a `data/` directory at the repository root, then knit the `R/*.Rmd` notebooks. `R/load_and_process_data.R` is sourced by each notebook to load and process the input data.
